...
# user needs "Cognitive Services OpenAI Contributor" permission to use the OpenAI API inst
AZURE_OPENAI_API_KEY=os.getenv("AZURE_OPENAI_KEY")
AZURE_OPENAI_ENDPOINT=os.getenv("AZURE_OPENAI_ENDPOINT")
AZURE_OPENAI_TEXT_DEPLOYMENT_NAME=os.getenv("AZURE_OPENAI_TEXT_DEPLOYMENT_NAME")
AZURE_OPENAI_CHAT_DEPLOYMENT_NAME=os.getenv("AZURE_OPENAI_CHAT_DEPLOYMENT_NAME")
AZURE_OPENAI_API_VERSION="2025-01-01-preview"
AZURE_OPENAI_EMBEDDING_DEPLOYMENT=os.getenv("AZURE_OPENAI_EMBEDDING_MODEL_NAME", "text-embedding-ada-002") 
